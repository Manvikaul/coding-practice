//HACKERRANK
// Ques: Given a sequence of n integers, p(0),p(1)...p(n)  where each element is distinct and satisfies 1<=p(x)<=n.
...
int findPos(int x, vector<int> p)
{
